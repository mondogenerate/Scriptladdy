...
# powershell -ep bypass .\Debloatr2023.ps1 -RemoveApps -Silent
# -DisableBing -DisableSuggestions -DisableTelemetry
...
# Define the list of apps as a string array
$appsList = @'
...
function RemoveApps {
    ...
    # Split the appsList string into an array of app names
    $apps = $appsList -split "`r`n" | Where-Object { $_ -notmatch '^#.*' -and $_ -notmatch '^\s*$' }
...
# Call the function with the appsList variable
RemoveApps -appsList $appsList -message "Removing Apps..."
